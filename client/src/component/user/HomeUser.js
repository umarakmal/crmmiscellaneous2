            ...
            <div className="mt-5">
                <div className="container " >
                    <div className="add_btn mt-2 mb-2">
                        <NavLink to="/adduser" className="btn btn-primary">Add data</NavLink>
                    </div>
                                    ...
                                    return (
                                        <>
                                            <tr key={id} >
                                                ...
                                                <td className="d-flex ">
                                                    <NavLink to={`view/user/${element._id}`}> <button className="btn btn-success"><i className='nav-icon fas fa-eye'/></button></NavLink>
                                                    <NavLink to={`edit/user/${element._id}`}>  <button className="btn btn-primary"><i className='nav-icon fas fa-edit'/></button></NavLink>
