...
const Menu = () => {
  ...
  <aside className="main-sidebar sidebar-dark-primary elevation-4">
    <a href="#" className="brand-link">
      <img src={logo} alt="Logo" className="brand-image" style={{opacity: '.9',maxHeight:'45px'}} />
        ...
        <ul className="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li className="nav-item menu-open mb-2">
            <a href="/admin" className="nav-link active">
              <i className="nav-icon fas fa-tachometer-alt" style={{color:'white'}}/>
              <p style={{color:'white'}}>
                Dashboard
          ...
          <i className="nav-icon far fa-user" style={{color:'white'}}></i>
