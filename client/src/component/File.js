    ...
    <div>
        ...
        <div className="container" style={{marginRight:'50px'}}>
            ...
            <div className="form-group">
                    ...
                    <input  filename='csvfile'  onChange={handleFile} style={{width:'50%'}} class="form-control" type="file" id="file" />
                    </div>
                    <button type="submit" onClick={addFile} className="btn btn-primary">Upload</button>
            </form>
            {/* <CsvToHtmlTable
